...
<div class="flex flex-col m-4">
    <form method="POST" action="{{route('generated::3Qv4KNWyIZG0Tbzv')}}" class="text-white flex gap-4 flex-col p-6">
        @csrf
        ...
        <button type="submit" class="w-full rounded-lg bg-white text-black px-2 py-3">Tambah Event</button>
    </form>
</div>