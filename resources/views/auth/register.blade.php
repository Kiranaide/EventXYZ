<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="mt-4">
            ...
            <x-gender-input id="gender" class="block mt-1 w-full" name="gender" :value="old('gender')" required autocomplete="gender" />
        ...
        <div class="mt-4">
            ...
            <x-role-input id="role" class="block mt-1 w-full" name="role" :value="old('role')" required autocomplete="role" />
